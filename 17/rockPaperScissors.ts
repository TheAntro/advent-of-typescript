...
type RockWins<Opponent> = Opponent extends "🖐🏾"
  ? "lose"
  : Opponent extends "✌🏽"
  ? "win"
  : "draw";
type PaperWins<Opponent> = Opponent extends "✌🏽"
  ? "lose"
  : Opponent extends "👊🏻"
  ? "win"
  : "draw";
type ScissorsWin<Opponent> = Opponent extends "👊🏻"
  ? "lose"
  : Opponent extends "🖐🏾"
  ? "win"
  : "draw";

type WhoWins<Opponent, Player> = Player extends "👊🏻"
  ? RockWins<Opponent>
  : Player extends "🖐🏾"
  ? PaperWins<Opponent>
  : Player extends "✌🏽"
  ? ScissorsWin<Opponent>
  : never;
